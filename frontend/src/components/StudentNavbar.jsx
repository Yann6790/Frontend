  ...
  return (
    <header className="bg-white border-b border-gray-200 px-6 h-16 flex justify-between items-center shadow-sm sticky top-0 z-50 font-merriweather">
      ...
      <div className="flex items-center gap-4">
        <span className="font-semibold text-gray-700 hidden sm:inline-block">Hello étudiant</span>
        <Link to="/profile" className="w-10 h-10 bg-gray-300 rounded-full border-2 border-purple-200 overflow-hidden hover:opacity-80 transition-opacity cursor-pointer shadow-sm">
          <img src="https://placehold.co/100x100/e2e8f0/94a3b8?text=AV" alt="Avatar" className="w-full h-full object-cover" />
        </Link>
